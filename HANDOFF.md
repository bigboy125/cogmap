...
| 包 | 状态 | 用途 |
|---|---|---|
| [`cogmap-core`](./packages/core) | 0.1.1 已上线 / 0.1.2 待发 | 协议核心：HTTPS 客户端 + file:// 本地模式 + JSON Schema |
| [`create-cogmap`](./packages/cli) | 0.1.1 已上线 / 0.1.2 待发 | 脚手架 CLI：`npx create-cogmap my-project` |
| [`cogmap-mcp`](./packages/mcp-server) | 0.1.0 待首发 | MCP server：暴露 INTEL 给 Claude Code / Cursor / Continue / Cline / Zed |
